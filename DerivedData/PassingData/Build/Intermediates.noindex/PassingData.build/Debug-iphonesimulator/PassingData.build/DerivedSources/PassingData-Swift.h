...
#ifndef PASSINGDATA_SWIFT_H
#define PASSINGDATA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PassingData",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11PassingData11AppDelegate")
...
SWIFT_CLASS("_TtC11PassingData13SceneDelegate")
...
SWIFT_CLASS("_TtC11PassingData20SecondViewController")
...
- (void)viewDidLoad;
- (IBAction)sendDataButton:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC11PassingData14ViewController")
